...
class APIConfig:
    ...
    DRILLDOWN_RANGES = ['20-60', '840-1200', '1600-2000', 
                        '2020-2220', '3320-3540', '3600-4000', 
                        '4400-4800', '5400-5600', '5680-5900', 
                        '6400-6880', '9400-9900', '12620-13000'
                        ]
...
def main():
    ...
    csv_filename = f"Data/scrapers/Toto/totoTennis{fetcher.now}.csv"
